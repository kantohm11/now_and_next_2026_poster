...
#column-box(heading: [The Span Setup: 1+1d, continuous $G$, finite $H subset G$])[
  ...
  - $cal(S)^("full") $: Full symmetry generated by $cal(C)$ and $G$.
]
...
#column-box(heading: [$"U"(1) + "TY"(ZZ_2)$: Kramers--Wannier Duality])[
  - $H = ZZ_2, G = "U"(1), cal(C) = "TY"(ZZ_2)$.
  - $i_(cal(C))^* "TQFT"("TY"(ZZ_2))
    in.rev ("SSB"_(ZZ_2) plus.o "triv"_(ZZ_2))^n$
    - $"SSB"_(ZZ_2)$ and $"triv"_(ZZ_2)$ exchanged by KW duality
  - $i_(cal(D))^* "TQFT"("U"(1)) in.rev "triv"_(ZZ_2)^m$
  #callout-important[
